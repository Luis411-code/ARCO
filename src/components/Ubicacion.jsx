...
const Ubicacion = () => {
  const { configuracion } = useAppContext();
  ...
  // ============================================================
  // ✅ UBICACIÓN EXACTA DE ARCO - Holguín, Cuba
  // ============================================================
  const lat = 20.884000;      // Latitud exacta
  const lng = -76.261688;     // Longitud exacta
  const direccion = "Calle Rastro No.117, esq. Luz Caballero, Holguín, Cuba";

  // URL para abrir en Google Maps (web o app)
  const mapsUrl = `https://www.google.com/maps?q=${lat},${lng}`;
  
  // URL para el iframe embed (sin API key requerida)
  const embedUrl = `https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15139.750000000002!2d${lng}!3d${lat}!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2z${lat}%2C${lng}!5e0!3m2!1ses!2scu!4v1700000000000`;
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-lg border border-gray-100">
              <iframe
                ...
                title="Ubicación de ARCO - Holguín"
                className="w-full"
              />
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{configuracion?.telefono1 || '54330343'}</p>
                    <p className="text-gray-600 text-sm">{configuracion?.telefono2 || '53785749'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{configuracion?.horario || 'Lun - Vie: 8:00 AM - 6:00 PM'}</p>
                  </div>
                </div>
              </div>
