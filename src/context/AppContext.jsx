...
const initialData = {
  ...
  serviciosDestacados: [
    { id: 'destacado-1', icono: '💡', titulo: 'Cartelería Lumínica', descripcion: 'Carteles con iluminación LED de bajo consumo, larga durabilidad y alta visibilidad. Ideales para exteriores.', link: '/servicios' },
  ...
  servicios: [
    // ===== CARTELERÍA (4) =====
    {
      ...
      desc: 'Carteles con iluminación LED de bajo consumo, larga durabilidad y alta visibilidad.',
      icono: '💡',
      precio: 'Desde $100',
    ...
    },
    {
      ...
      icono: '👕',
      precio: 'Desde $18',
      imagenes: ['IMG-20260723-WA0051.jpg'],
      categoria: 'Impresión',
      camposFormulario: [
    ...
    // ===== MONTAJE (5) =====
    {
      ...
      icono: '🔧',
      precio: 'Desde $30',
      imagenes: ['IMG-20260723-WA0064.jpg'],
      categoria: 'Montaje',
      camposFormulario: [
...
export const AppProvider = ({ children }) => {
  ...
  // ===== FUNCIONES PARA TESTIMONIOS APROBADOS =====
  ...
  // ===== FUNCIONES PARA TESTIMONIOS PENDIENTES =====
